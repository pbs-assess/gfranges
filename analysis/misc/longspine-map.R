# longspine thornyhead CPUE map for 1996-2020.
...
d <- readRDS("analysis/misc/data/longspine-thornyhead-cpue-hist.rds")
...
ggsave("analysis/misc/mcp_CPUE_1996to2020.png", width = 7, height = 7)

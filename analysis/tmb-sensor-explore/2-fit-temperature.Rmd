...
```{r}
temp1 <- loglik_cv(d_trawl, n_knots = 100, 
...
temp2 <- loglik_cv(d_trawl, n_knots = 100, 
                   formula = temperature_c ~ 0 + as.factor(year) + depth_scaled + depth_scaled2,
                   time = "year", family = gaussian(link = "identity"), 
                   ar1_fields = FALSE, include_spatial = FALSE)
sum(temp2$nll)

temp3 <- loglik_cv(d_trawl, n_knots = 100, 
...
temp1_rw <- loglik_cv(d_trawl, n_knots = 100,
...
temp2_rw <- loglik_cv(d_trawl, n_knots = 100, 
                   formula = temperature_c ~ 0 + as.factor(year),
...
temp3_rw <- loglik_cv(d_trawl, n_knots = 100, 
                   formula = temperature_c ~ 0 + as.factor(year),

...
glimpse(cv$summary)
write.csv(cv$summary, file = "cv-test.csv")
cv_test <- read_csv(file = "cv-test.csv")
glimpse(cv)
View(cv$summary)
...
All of top models for any seed contained year and non showed a linear effect of depth
```{r}
cv_args <- generate_cv_args(
  formula = list(
...
non_time_varying1 <- read.csv(file = "cv-non-time-varying1.csv")
time_varying1 <- read.csv(file = "cv-time-varying1.csv")
vary_rf1 <- read.csv(file = "cv-varying-rf1.csv")
refine_knots1 <- read.csv(file = "cv-refine-knots1.csv")
more_seeds <- read.csv(file = "cv-more-seeds.csv")
more_seeds1 <- read.csv(file = "cv-more-seeds1.csv")

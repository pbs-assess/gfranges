...
Load data
```{r}
# d_trawl1 <- readRDS(here::here("analysis/tmb-sensor-explore/sensor-data-processed.rds"))
# nrow(d_trawl1)
d_trawl <- readRDS(here::here("analysis/tmb-sensor-explore/dat-sensor-trawl-SST.rds"))
nrow(d_trawl)

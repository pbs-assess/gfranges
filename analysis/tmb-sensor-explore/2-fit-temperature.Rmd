...
10-fold cross-validation of candidate models
```{r}
temp1 <- loglik_cv(data = d_trawl, n_knots = 30, x = "X", y ="Y", k_folds = 5, plot_spde = TRUE,
                   formula = temperature_c ~ 0 + as.factor(year) + depth_scaled,
                   time = "year", family = gaussian(link = "identity"), 
                   ar1_fields = FALSE, include_spatial = FALSE)
sum(temp1$sum_loglik)

temp2 <- loglik_cv(data = d_trawl, n_knots = 30, x = "X", y ="Y", k_folds = 5, plot_spde = TRUE,
                   formula = temperature_c ~ 0 + as.factor(year) + depth_scaled + depth_scaled2,
                   time = "year", family = gaussian(link = "identity"), 
                   ar1_fields = FALSE, include_spatial = FALSE)
sum(temp2$sum_loglik)

temp3 <- loglik_cv(data = d_trawl, n_knots = 30, x = "X", y ="Y", k_folds = 5, plot_spde = TRUE,
...
temp1_rw <- loglik_cv(data = d_trawl, n_knots = 30, x = "X", y ="Y", k_folds = 5, plot_spde = TRUE,
...
temp2_rw <- loglik_cv(data = d_trawl, n_knots = 30, x = "X", y ="Y", k_folds = 5, plot_spde = TRUE,
                   formula = temperature_c ~ 0 + as.factor(year),
...
temp3_rw <- loglik_cv(data = d_trawl, n_knots = 30, x = "X", y ="Y", k_folds = 5, plot_spde = TRUE,
                   formula = temperature_c ~ 0 + as.factor(year),
...
```{r}
qcs_grid$depth2 <- (qcs_grid$depth_scaled)^2
qcs_grid$depth3 <- (qcs_grid$depth_scaled)^3
```

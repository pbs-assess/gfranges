...
saveRDS(do_model_all_DOY, file = (here::here(
  paste0("analysis/tmb-sensor-explore/models/model-do-without-wcvi2016b-", 
    "800kn", #Sys.Date(), 
    ".rds")))
  )
```
...
```{r eval=FALSE}
# do_model_all_DOY <- readRDS((here::here("analysis/tmb-sensor-explore/models/model-do-without-wcvi2016-depth3.rds")))
# do_model_all_DOY <- readRDS((here::here("analysis/tmb-sensor-explore/models/model-do-without-wcvi2016-depth2.rds")))
# do_model_all_DOY <- readRDS((here::here("analysis/tmb-sensor-explore/models/model-do-without-wcvi2016-800kn.rds")))
...
good_rows <- filter (predictions, abs != "Inf")
sum(good_rows$abs)
19719.73-17459.49
...
pred_4 <- plot_map_raster(p_nd4, "do_est") +
  scale_fill_viridis_c(labels = labels, breaks = c(0,2,4,6,8), limits = c(0, 7), 
     na.value = "red")+
  facet_wrap(~year) +
  labs(fill = "ml/L DO") +
  #ggtitle(" ")+ 

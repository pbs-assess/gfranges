...
saveRDS(do_model_all_DOY, file = (here::here(
  paste0("analysis/tmb-sensor-explore/models/model-do-without-wcvi2016-", 
    "800kn", #Sys.Date(), 
    ".rds")))
  )
```
...
model2 <- readRDS(here::here("analysis/tmb-sensor-explore/models/model-do-without-wcvi2016-800kn.rds"))
...
```{r}
p_nd <- readRDS((here::here("analysis/VOCC/data/predicted-DO-2020-06-19.rds")))

...
try({  adult_biomass <- readRDS(paste0(
    "data/", spp,
    "/mod-mat-biomass-", spp, "-trawled-ssid-1n3n4n16-prior-FALSE.rds"
  ))
  imm_biomass <- readRDS(paste0(
    "data/", spp,
    "/mod-imm-biomass-", spp, "-trawled-ssid-1n3n4n16-prior-FALSE.rds"
  ))
 # depth_model_list <- list(adult = adult_biomass, imm = imm_biomass)
    ...
    "data/", spp,
    "/mod-total-biomass-", spp, "-trawled-ssid-1n3n4n16-prior-FALSE.rds"
  ))
      })
    }
...
if(model_w_do) {
png(
  file = paste0("figs/", spp, "/do-both-log-", spp, x2016, covs, "-priors-", priors, ".png"),
  res = 600,
  units = "in",
  width = 8.5,
  height = 11
...
```{r eval=F}
png(
  file = paste0("figs/", spp, "/temp-both-log-", spp, x2016, covs, "-priors-", priors, ".png"),
  res = 600,
  units = "in",
  width = 8.5,
  height = 11

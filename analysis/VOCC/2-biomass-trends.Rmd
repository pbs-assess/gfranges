...
if (exists("adult_predictions")) {
  ...
  if (3 %in% model_ssid) {
    adult_predictions3 <- adult_predictions %>%
      filter(ssid != 16) %>%
      filter(ssid != 4)
  } else {

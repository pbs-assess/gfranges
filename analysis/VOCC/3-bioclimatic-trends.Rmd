...
if (any(names(maturity) == "adult_density")) {
  ...
  ad_model_2013 <- readRDS(paste0("data/", spp, 
        "/mod-mat-biomass-", spp,"-fixed-past-2013-", ssid_string, "-prior-", priors, ".rds"))
  ...
  ad_model_2015 <- readRDS(paste0("data/", spp, 
        "/mod-mat-biomass-", spp,"-fixed-past-2015-", ssid_string, "-prior-", priors, ".rds"))
  ...
  ad_model_2017 <- readRDS(paste0("data/", spp, 
        "/mod-mat-biomass-", spp,"-fixed-past-2017-", ssid_string, "-prior-", priors, ".rds"))
  ...
  adult_2017_multi <- predict(ad_model_past, newdata = fake_2017_minus4, return_tmb_object = TRUE)
 ...
 past_predictions <- adult_pre_2015$data %>% 
  ...
  bioclim_2015_start <- filter(adult_past$data, year >= 2013) %>% filter(year <= 2014) %>%
  ...
  bioclim_2015 <- filter(adult_2015$data, year >= 2015) %>% filter(year <= 2016) %>%

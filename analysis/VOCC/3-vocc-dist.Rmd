...
```{r}
rm(gf2)
try({gf2 <- readRDS(paste0("data/_climate_vocc/temp-vocc-", climate_mod, "-scale-", scale_fac, "-ssid", ssid_string, "-years-", years_sampled, ".rds"))
})
...
print( paste("min SD =", round(temp_min_sd, digits = 3)))
print( paste("median SD =", round(temp_median_sd, digits = 3)))

print( paste("treshold chosen =", round(temp_min_sd*2, digits = 3), "degrees C"))
...
try({gf0 <- readRDS(paste0("data/_climate_vocc/DO-vocc-", climate_mod, "-scale-", scale_fac, "-ssid", ssid_string, "-years-", years_sampled, ".rds"))
})
...
print( paste("min SD =", round(do_min_sd, digits = 3)))
print( paste("median SD =", round(do_median_sd, digits = 3)))

print( paste("treshold chosen =", round(do_min_sd*2, digits = 3), "ml/L"))
...
write.csv(vocc, file = paste0(
  "data/_more2016_", age, "/", age, "-w-do-nulls-", spp, "-", ssid_string, covs, "-", min(d$year), "-", max(d$year), ".csv"
))
```

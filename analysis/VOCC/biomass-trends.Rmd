...
if (update_spatial_model) {
  ...
  if (any(names(data) == "adult_density")) {
    ...
    saveRDS(adult_biomass, file = paste0("data/", spp, "/mod-mat-biomass-", spp, covariates, "-", ssid_string, "-prior-", priors, time1, ".rds"))
    ...
    saveRDS(imm_biomass, file = paste0("data/", spp, "/mod-imm-biomass-", spp, covariates, "-", ssid_string, "-prior-", priors, time2, ".rds"))
  } else {
    starttime3 <- Sys.time()
    ...
    saveRDS(total_biomass, file = paste0("data/", spp, "/model-total-biomass-", spp, covariates, "-", ssid_string, "-prior-", priors, ".rds"))
  }
}
```
...
if (isFALSE(update_spatial_model)) {
  if (region != "All synoptic surveys") {
    try(adult_predictions <- readRDS(paste0("data/", spp, "/predictions-", spp, covariates, "-", ssid_string, "-mature-biomass-prior-", priors, ".rds")))
    try(imm_predictions <- readRDS(paste0("data/", spp, "/predictions-", spp, covariates, "-", ssid_string, "-imm-biomass-prior-", priors, ".rds")))
    try(predictions <- readRDS(paste0("data/", spp, "/predictions-", spp, covariates, "-", ssid_string, "-total-biomass-prior-", priors, ".rds")))
  } else {
...
if (!exists("adult_predictions")) {
  ...
  if (length(unique(fish$maturity_code)) > 2) {
    ...
    adult_biomass <- readRDS(list.files(
      ...
      pattern = paste0("mod-mat-biomass-", spp, covariates, "-", ssid_string, "-prior-", priors, "-*"),
    ...
    saveRDS(adult_predictions,
      file = paste0("data/", spp, "/predictions-", spp, covariates,"-", ssid_string, "-mature-biomass-prior-", priors, ".rds")
    )

    imm_biomass <- readRDS(list.files(
      path = paste0("data/", spp, "/"),
      #pattern = paste0("model-imm-biomass-", spp, "-", ssid_string, "-prior-", priors, "-*"),
      pattern = paste0("mod-imm-biomass-", spp, covariates, "-", ssid_string, "-prior-", priors, "-*"),
      all.files = F, full.names = T
    ))
    imm_predictions <- predict(imm_biomass, newdata = nd)
    saveRDS(imm_predictions,
      file = paste0("data/", spp, "/predictions-", spp, covariates,"-", ssid_string, "-imm-biomass-prior-", priors, ".rds")
    )
  } else {
    rm(adult_predictions)
    rm(imm_predictions)
    ...
    if (!exists(predictions)) {
      ...
      total_biomass <- readRDS(paste0("data/", spp, "/model-total-biomass-", spp, covariates, "-", ssid_string, "-prior-", priors, ".rds"))
      nd$year <- as.integer(nd$year)
      predictions <- predict(total_biomass, newdata = nd)
      saveRDS(predictions, file = paste0("data/", spp, "/predictions-", spp, covariates,"-", ssid_string, "-total-biomass-prior-", priors, ".rds"))
    }
  }
}
```
...
if (region == "All synoptic surveys") {
  if (isFALSE(update_spatial_model)) {
    try(
      pred1n3 <- readRDS(paste0("data/", spp, "/predictions-", spp, covariates, "-1n3-mature-biomass-prior-", priors, ".rds")),
      pred4 <- readRDS(paste0("data/", spp, "/predictions-", spp, covariates, "-4-mature-biomass-prior-", priors, ".rds")),
      pred16 <- readRDS(paste0("data/", spp, "/predictions-", spp, covariates, "-16-mature-biomass-prior-", priors, ".rds")),
    ...
    try(
      pred1n3_imm <- readRDS(paste0("data/", spp, "/predictions-", spp, covariates, "-1n3-imm-biomass-prior-", priors, ".rds")),
      pred4_imm <- readRDS(paste0("data/", spp, "/predictions-", spp, covariates, "-4-imm-biomass-prior-", priors, ".rds")),
      pred16_imm <- readRDS(paste0("data/", spp, "/predictions-", spp, covariates, "-16-imm-biomass-prior-", priors, ".rds")),
...
saveRDS(out_mature,
  file = paste0("data/", spp, "/trends-", spp, covariates, "-", ssid_string, "-mature-biomass-priors-", priors, ".rds")
)

if (!exists("adult_predictions")) {
  out_total <- out_mature
  saveRDS(out_total,
    file = paste0("data/", spp, "/trends-", spp, covariates, "-", ssid_string, "-total-biomass-priors-", priors, ".rds")
  )
}
```
...
```{r, error=TRUE}
try(out_mature <- readRDS(paste0("data/", spp, "/trends-", spp, covariates, "-", ssid_string, "-mature-biomass-priors-", priors, ".rds")))
...
if (exists("out_mature")) {
  ...
  try(out_total <- readRDS(paste0("data/", spp, "/trends-", spp, covariates, "-", ssid_string, "-total-biomass-priors-", priors, ".rds")))
...
if (exists("imm_predictions")) {
  ...
  saveRDS(out_imm,
    file = paste0("data/", spp, "/trends-", spp, covariates, "-", ssid_string, "-immature-biomass-priors-", priors, ".rds")
  )
} else {
  rm(out_imm)
}
...
```{r}
try(out_imm <- readRDS(paste0("data/", spp, "/trends-", spp, covariates, "-", ssid_string, "-immature-biomass-priors-", priors, ".rds")))
...
```{r}
png(
  file = paste0("figs/", spp, "/trends-", spp, covariates, "-", ssid_string, "-priors-", priors, ".png"), # The directory you want to save the file in
  res = 600,
  units = "in",
...
png(
  file = paste0("figs/", spp, "/biomass-", spp, covariates, "-", ssid_string, "-priors-", priors, ".png"), # The directory you want to save the file in
  res = 600,
  units = "in",
...
```{r}
png(
  file = paste0("figs/", spp, "/exploratory-", spp, covariates, "-", ssid_string, "-priors-", priors, ".png"), # The directory you want to save the file in
  res = 600,
  units = "in",

...
if (any(names(data) == "adult_density")) {
  ...
  try({adult_biomass <- readRDS(paste0("data/", spp,
    "/mod-mat-biomass-", spp, covs, "-", ssid_string, "-prior-", priors, ".rds"))
...
```{r}
  try({ biomass <- readRDS(paste0("data/", spp,
    "/mod-mat-biomass-", spp, covs, "-", ssid_string, "-prior-", priors, ".rds"))
  })
...
saveRDS(point_predictions, file = paste0("data/", spp,
    "/check-mod-predictions-", spp, covs, "-", ssid_string, "-prior-", priors, ".rds"))
...
depth_only_predictions <- filter(depth_only_predictions, 
...
#adult_biomass<-sdmTMB:::update_model(adult_biomass) 
  ...
  try({  imm_biomass <- readRDS(paste0(
    "data/", spp,

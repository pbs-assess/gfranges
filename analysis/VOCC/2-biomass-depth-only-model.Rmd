...
if (params$update_model) {
  ...
  if (any(names(data) == "adult_density")) {
   ...
   # })
    ...
    #   "data/", spp,
    #   "/model-total-biomass-", spp, covs, "-", ssid_string, "-new.rds"
    # ))
  }
  tictoc::toc()
}
...
if (any(names(data) == "adult_density")) {
  ...
  try({
    imm_biomass <- readRDS(paste0(
      "data/", spp,
      "/mod-imm-biomass-", spp, covs, "-", ssid_string, "-new.rds"
    ))
    ...
    saveRDS(imm_predictions, file = paste0(
      "data/", spp,
      "/predictions-", spp, covs, "-", ssid_string, "-imm-biomass-new.rds"
    ))
  })
} else {
  try({
  ...
  saveRDS(predictions, file = paste0(
    "data/", spp,
    "/predictions-", spp, covs, "-", ssid_string, "-total-biomass-new.rds"
  ))
  })
}
}
...
try({
  imm_biomass <- readRDS(paste0(
    "data/", spp,
    "/mod-imm-biomass-", spp, covs, "-1n3n4n16-new.rds"
  ))

...
```{r}
biomass <- readRDS("data/maturity-biomass-data-pop-1n3.rds")
...
```{r}
adult_predictions$est_exp <- exp(adult_predictions$est)
...
```{r}
imm_predictions$est_exp <- exp(imm_predictions$est)
...
```{r}
png(file = "exploratory-pop-figs.png",   # The directory you want to save the file in
res = 600,
units = 'in',

...
```{r global-coefs-w-age, fig.cap="Overall coefficient estimates for model with mature as the intercept and two-way interactions with immature.", out.width="3in"}
# include_graphics(here("ms", "figs", "supp-global-coefs-w-age.pdf"))
```

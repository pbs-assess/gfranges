...
<!-- TODO: figures to consider
-   temperature and O2 maps and velocities; 4 panel
...
-   plot coefficients against depth etc.... adults and immature separately?
-->
...
```{r climate-maps, fig.cap="Caption goes here", out.width="6in"}
include_graphics(here("ms", "figs", "climate-maps.pdf"))
```

\clearpage

```{r worm-plots, fig.cap="Caption goes here", out.width="8in"}
...
```{r temp-chops, fig.cap="Caption goes here", out.width="8in"}
# include_graphics(here("ms", "figs", "temp-chops.pdf"))
```

\clearpage

```{r do-chops, fig.cap="Caption goes here", out.width="8in"}
# include_graphics(here("ms", "figs", "do-chops.pdf"))
```

\clearpage

```{r slope-by-depth, fig.cap="Caption goes here", out.width="5in"}
...
```{r coef-scatterplots, fig.cap="Caption goes here", out.width="8in"}

...
For groundfish it is well established that some species shift their depth distribution as they age (often approximated by fish length bins; REF e.g.
Li et al 2019).
...
These surveys follow a random depth stratified design and use the same bottom trawl fishing gear and fishing protocols (Sinclair et al. 2003.
...
Because ontogenetic shifts in habitat, particularly depth, are well documented in groundfish species (Mindel et al. 2016, Barbeaux and Hollowed 2018, Li et al. 2019), we estimate biomass densities separately for mature and immature size classes whenever possible (maturity is not assessed for certain Chondrichthians, or when catches are particularly low).
...
We then modeled expected biomass density through space and time separately for adults and immatures of each species using spatial GLMMs (e.g., Shelton et al. 2014, Thorson et al. 2015, 2016, Ward et al. 2015).
...
The spatial components were modeled as random fields, using a triangulated mesh with vertices at 400 knots to approximate a continuous spatial field (Rue et al. 2009, Lindgren et al. 2011).
